...
from gnnmodel.OptimizedGATClassifier import OptimizedGATClassifier
...
class sumModel(nn.Module):
    def __init__(self, in_dim, hidden_dim, n_classes ,embeddings_matrixcnn, db, node_vec_stg, device=None, layer_num=2,
       ...
       # self.embedding_matrix = embedding_matrix
        ...
        x = import_module('gnnmodel.' + 'TextCNN')
